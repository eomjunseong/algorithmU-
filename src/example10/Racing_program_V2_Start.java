...
public class Racing_program_V2_Start implements Racing{
    String name ;
    Scanner scan = new Scanner(System.in);
    int count = 1;
    int distane = 0 ;
    int[] speed={10,20,5,1};//전진, 가속, 회전, 후진
    Racing_program_V2_Start(String name){
        this.name=name;
    }
    ...
    void uprade(){
        System.out.println("------------------------------------");
        System.out.printf("[안내] (캐쉬충전)%s님. 차량 업그레이드를 진행하였습니다.",name);
        System.out.println("------------------------------------\n");
    ...
    public static void main(String[] args) {
        ...
        Racing_program_V2_Start myCar = new Racing_program_V2_Start("엄준승");
        System.out.println("기본 속도 10\n" +
                ...
                "액션 마다, 누적된 주행 거리 노출\n" +
                "속도 * 시간(애션당 1초) = 이동거리");
        System.out.println("업그레이시 속도 두배 ");
        //시작
        myCar.start();
        //가속
        myCar.accelerate();
